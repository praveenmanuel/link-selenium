...
public class TC06_SmokeTest extends BaseClass {
    ...
    public boolean redirectedToEnvironmentURL(String url, String env)
    {
        ...
        {
            Assert.assertTrue("URL is not redirected to Environment URL after logging in", url.equals("https://dev.nhsnlink.org/generate"));
            redirected = true;
        }
        else if (env.equalsIgnoreCase(("demo")))
        {
            Assert.assertTrue("URL is not redirected to Environment URL after logging in", url.equals("https://demo.nhsnlink.org/generate"));
            redirected = true;
        }
